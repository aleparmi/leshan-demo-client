...
public class LeshanClientDemo {
    ...
    public static void main(final String[] args) {
        ...
        options.addOption("cid", true, "Control usage of DTLS connection ID." //
                + "\n - Positive value define the size in byte of CID generated. (rarely needed for client)"
                + "\n - 0 value means we accept to use CID but will not generated one for foreign peer. (classic client usage)"
                + "\n - Negative value or 'none' value deactivate usage of CID" + "\n (Default: none)");
